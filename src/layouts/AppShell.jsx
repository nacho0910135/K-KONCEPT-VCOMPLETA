    ...
    <div className="min-h-screen bg-neutral-50">
      <header className="sticky top-0 z-30 border-b border-neutral-200 bg-white/95 backdrop-blur">
        <div className="flex h-16 items-center gap-3 px-4 lg:px-6">
          ...
          <NavLink to="/" className="flex items-center gap-2 font-bold text-neutral-900">
            <span className="grid h-9 w-9 place-items-center rounded-md bg-primary-600 text-white">K</span>
            <span className="hidden sm:inline">Kollab Koncepts</span>
          </NavLink>
        ...
        <nav className="grid gap-1">
          {navItems.map(({ to, label, icon: Icon }) => (
            <NavLink
              ...
              className={({ isActive }) => clsx('flex items-center gap-3 rounded-md px-3 py-2.5 text-sm font-semibold transition', isActive ? 'bg-primary-50 text-primary-700' : 'text-neutral-600 hover:bg-neutral-100')}
            >
